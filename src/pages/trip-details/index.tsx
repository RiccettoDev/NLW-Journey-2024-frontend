      ...
      <main className="flex gap-16 px-4">
        <div className="flex-1 space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2.5">
              <div className="flex gap-2 items-baseline">
                <span className="text-xl text-zinc-400 font-semibold">Dia 18</span>
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="space-y-1.5">
                  ...
                  <a href="#" className="block text-xs text-zinc-400 truncate hover:text-zinc-200">
                    https://www.airbnb.com.br/rooms/104700011jhvfhjvhjvjhvjhvhjvhjvjhbv
                  </a>
                </div>
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            >
              <div className='h-14 px-5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
                ...
                <input
                  name='title'
                  placeholder="Digite qual a sua atividade"
